<template>
    ...
    <layout :time="time" :user="user" :check="check">
        <div>
            ...
            <h1 class="title">هدف پس انداز</h1>
        ...
        <span class="text-danger mr-2" style="vertical-align: super">(با ایجاد هدف جدید ، هدف قبلی حذف خواهد شد !)</span>
        <table class="table table-dark table-hover">
            <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col">نام هدف</th>
                <th scope="col">مبلغ کل هدف</th>
                <th scope="col">مبلغ پس انداز شده</th>
            ...
            <tr v-else>
                <td colspan="5" class="text-danger text-center">شما هنوز هیچ هدفی مشخص نکرده اید</td>
            </tr>
            </tbody>
        </table>
        <div class="container mx-auto text-center mt-4"  v-if="selectDataValidate && goal !=null">
            <form @submit.prevent="form.put(route('goal.update',form.id))" class="text-cente">
                <div class="mb-3 mt-3 col-6 mx-auto mt-6" >
